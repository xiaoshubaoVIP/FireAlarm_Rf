...
typedef enum {
   ...
   DMA_VECTOR_SR0       =  8U,  /* UART0接收传送结束/SPI01传送结束或者缓冲器空 */
   DMA_VECTOR_SPI01     =  8U,  /* UART0接收传送结束/SPI01传送结束或者缓冲器空 */
   DMA_VECTOR_ST0       =  9U,  /* UART0发送传送结束/SPI00传送结束或者缓冲器空 */
   DMA_VECTOR_SPI00     =  9U,  /* UART0发送传送结束/SPI00传送结束或者缓冲器空 */
   DMA_VECTOR_SR1       = 10U,  /* UART1接收传送结束/SPI11传送结束或者缓冲器空 */
   DMA_VECTOR_SPI11     = 10U,  /* UART1接收传送结束/SPI11传送结束或者缓冲器空 */
   DMA_VECTOR_ST1       = 11U,  /* UART1发送传送结束/SPI10传送结束或者缓冲器空 */
   DMA_VECTOR_SPI10     = 11U,  /* UART1发送传送结束/SPI10传送结束或者缓冲器空 */
   DMA_VECTOR_SR2       = 12U,  /* UART2接收传送结束/SPI21传送结束或者缓冲器空 */
   DMA_VECTOR_SPI21     = 12U,  /* UART2接收传送结束/SPI21传送结束或者缓冲器空 */
   DMA_VECTOR_ST2       = 13U,  /* UART2发送传送结束/SPI20传送结束或者缓冲器空 */
   DMA_VECTOR_SPI20     = 13U,  /* UART2发送传送结束/SPI20传送结束或者缓冲器空 */
