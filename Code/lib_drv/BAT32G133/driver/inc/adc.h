...
#define _10_AD_INPUT_PGA0                       (0x10U) /* PGAO of PGA0 is used to be the input channel */
#define _20_AD_INPUT_PGA1                       (0x20U) /* PGAO of PGA1 is used to be the input channel */
...
#define ADCHPGA0_Pos  	4 
#define ADCHPGA1_Pos  	5 
#define ADISS_Pos  	    7 
