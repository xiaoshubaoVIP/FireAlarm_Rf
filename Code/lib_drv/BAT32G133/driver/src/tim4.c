...
void TM40_One_Shot_Pulse_Output(tm4_edge_t edge, uint16_t delay, uint16_t width)
{
    ...
    /* Start specify channel */
    TM40_Channel_Start((tm4_channel_t)(TM4_CHANNEL_0 | TM4_CHANNEL_1));
}
/***********************************************************************************************************************
...
void TM40_PWM_1Period_2Duty(uint16_t period, uint16_t duty1, uint16_t duty2)
{
    ...
    /* Start specify channel */
    TM40_Channel_Start((tm4_channel_t)(TM4_CHANNEL_0 | TM4_CHANNEL_1 | TM4_CHANNEL_2));
}
/***********************************************************************************************************************
...
void TM40_PWM_1Period_3Duty(uint16_t period, uint16_t duty1, uint16_t duty2, uint16_t duty3)
{
    ...
    /* Start specify channel */
    TM40_Channel_Start((tm4_channel_t)(TM4_CHANNEL_0 | TM4_CHANNEL_1 | TM4_CHANNEL_2 | TM4_CHANNEL_3));
}
/***********************************************************************************************************************
...
void TM41_One_Shot_Pulse_Output(tm4_edge_t edge, uint16_t delay, uint16_t width)
{
    ...
    /* Start specify channel */
    TM41_Channel_Start((tm4_channel_t)(TM4_CHANNEL_0 | TM4_CHANNEL_1));
}
/***********************************************************************************************************************
...
void TM41_PWM_1Period_2Duty(uint16_t period, uint16_t duty1, uint16_t duty2)
{
    ...
    /* Start specify channel */
    TM41_Channel_Start((tm4_channel_t)(TM4_CHANNEL_0 | TM4_CHANNEL_1 | TM4_CHANNEL_2));
}
/***********************************************************************************************************************
...
void TM41_PWM_1Period_3Duty(uint16_t period, uint16_t duty1, uint16_t duty2, uint16_t duty3)
{
    ...
    /* Start specify channel */
    TM41_Channel_Start((tm4_channel_t)(TM4_CHANNEL_0 | TM4_CHANNEL_1 | TM4_CHANNEL_2 | TM4_CHANNEL_3));
}
/***********************************************************************************************************************
...
uint16_t TM41GetCnt(tm4_channel_t ch)
{
	uint16_t CntData = 0;
