...
static void _HidePinInit(void)
{
    ...
    M0P_GPIO->P0ADS &= 0x07;     ///< P03配置为数字端�?
	M0P_GPIO->P3ADS &= 0xE3;     ///< P32/P33/P34配置为数字端�?
	
    M0P_GPIO->P0DIR	|= 0xF8;     ///< P03配置为端口输�?
    M0P_GPIO->P3DIR	|= 0x1C;     ///< P32/P33/P34配置为端口输�?
	
	M0P_GPIO->P0PU  |= 0xF8;     ///< P03配置为上�?
	M0P_GPIO->P3PU  |= 0x1C;     ///< P32/P33/P34配置为上�?
